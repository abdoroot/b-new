    ...
    return (
        <AdminLayout>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-stone-900">Areas</h1>
                    <p className="text-stone-500">Manage geographical areas for land opportunities.</p>
                </div>
                <Link
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-stone-50 border-b border-stone-200">
                                ...
                                <th className="px-6 py-4 text-xs font-semibold text-stone-500 uppercase">City</th>
